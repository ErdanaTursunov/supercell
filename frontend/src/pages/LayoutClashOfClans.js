    ...
    <div className="clash-app-cs">
      <header className="app-header-cs">
        <div className="logo-cs" onClick={() => (window.location.href = "/")}>
          <img
            src="/img/app-icon-clashofclans.png"
      ...
      <main className="content-cs">
        {showCart ? (
          <div className="cart-container-cs">
            <h2>
              <span className="section-icon">🛒</span> Ваша корзина
            </h2>
            {cart.length === 0 ? (
              ...
              <>
                <div className="cart-items-cs">
                  {cart.map((item) => (
                    <div
                      key={`cart-${item.id}`}
                      className={`cart-item-cs ${getRarityClass(item.GameItem.GameItemDetail.rarity)}`}
                    >
                      <img
                        src={
                          item.GameItem
            ...
            <button
              className="continue-shopping-cs"
                ...
                >
                  ...
                  <div className="product-image-cs">
                    ...
                    {product.GameItemDetail.type === "pass" && (
                      <div className="special-badge">СПЕЦИАЛЬНО</div>
                    )}
                  </div>
                  <div className="product-info-cs">
                    <h3>{product.name}</h3>
                    <p className="product-description-cs">
                      {product.description}
                    </p>
                    <div className="product-price-cs">
                      <span className="price-cs">
                        ${product.GameItemDetail.price}
                      </span>
                      <span className="gems-cs">
