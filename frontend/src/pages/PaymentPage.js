  ...
  const handleProcessPayment = async () => {
    ...
    try {
      ...
      const deleteRequests = cartItems.map((item) =>
        axios.delete(
          `${process.env.REACT_APP_API_URL}/api/cart/items/${item.id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
            ...
            <div className="payment-section payment-details">
              ...
              <div className="payment-form">
                ...
                <div className="demo-notice">
                  <p>
                    This is a demo checkout page. No actual payment will be
                    processed.
                  </p>
                  <p>
                    Clicking "Complete Purchase" will simulate a successful
                    payment.
                  </p>
                </div>
